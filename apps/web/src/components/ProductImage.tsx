...
export function ProductImage({
  ...
  return (
    <div
      className={`flex items-center justify-center bg-noir ${className}`}
      role="img"
      aria-label={alt}
    >
...
function WatchGlyph() {
  return (
    <svg
      viewBox="0 0 200 200"
      className="relative h-[62%] w-[62%] text-gold/70"
      fill="none"
      stroke="currentColor"
      strokeWidth="1.5"
    >
      ...
      {Array.from({ length: 12 }).map((_, i) => {
        ...
        return (
          <line
            ...
            x2={100 + Math.sin(a) * 49}
            y2={100 - Math.cos(a) * 49}
...
function PerfumeGlyph() {
  return (
    ...
    >
      ...
      <path
        d="M62 78 C62 62 78 54 100 54 C122 54 138 62 138 78 L142 160 C142 172 132 182 120 182 L80 182 C68 182 58 172 58 160 Z"
        strokeWidth="3"
      />
